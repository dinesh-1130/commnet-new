...
export default function WhyChooseUs() {
  ...
  const team = [
    ...
    { name: "Carlos Silva", title: "VP, Operations", image: "/assets/profile-2.jpg" },
    { name: "Sophia Lee", title: "Director, Design", image: "/assets/profile-3.jpg" },
    { name: "Amit Jain", title: "Director, Engineering", image: "/assets/profile-4.jpg" },
    { name: "Nina Rao", title: "HR Head", image: "/assets/profile-5.jpg" },
    { name: "David Kim", title: "Head of Innovation", image: "/assets/profile-1.jpg" },
    { name: "Leena Shah", title: "Customer Success Lead", image: "/assets/profile-2.jpg" }
  ];
          ...
          <div className="w-full">
            ...
            <div className="bg-sky-600 text-white p-10 text-center">
              ...
              <h2 className="text-4xl font-bold mb-4">
                Meet Our <span className="text-red-300">Leadership</span> Team
              </h2>
